...
{
    public class UIBuyHistoryList : MonoBehaviour
    {
        ...
        {
            RestClient.Result<AuctionListResponse> result = await BaseGameNetworkManager.Singleton.AuctionRestClientForClient.GetBuyHistoryList(limitPerPage, page);
